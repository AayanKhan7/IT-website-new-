...
interface GridItem {
  id: number;
  type: 'image-text' | 'color' | 'image-logo' | 'image' | 'color-image' | 'overlay' | 'overlay-small' | 'earnings';
  span: 3 | 4 | 6;
  src?: string;
  title?: string;
  content?: string;
...
const gridData: GridItem[] = [
  // row 1
  {
    ...
    title: 'ALPHA GROUPS: Intelligence\nDream. Solve. Prove. Repeat.',
  },
  {
    id: 2, type: 'color', span: 3, bgColor: '#1E5EFF',
    title: 'EXPERIENCE "ALPHA GROUPS INTELLIGENCE" AT WORLD ECONOMIC FORUM 2025.',
    link: 'READ MORE >'
  },
  {
  ...
  {
    id: 4, type: 'color', span: 3, bgColor: '#2E6BFF',
    title: 'ALPHA GROUPS INTELLIGENCE: THE AI-INFUSED PLATFORM FOR ENTERPRISE-SCALE TRANSFORMATION',
    link: 'READ MORE >'
  },
  
  // row 2
  {
    id: 5, type: 'color', span: 3, bgColor: '#08152d',
    title: 'INTRODUCING THE ALPHA GROUPS INNOVATION NETWORK',
  ...
  {
    id: 7, type: 'color', span: 3, bgColor: '#1E5EFF',
    title: "ALPHA GROUPS LAUNCHES NEXT-GEN DIGITAL TRANSFORMATION SOLUTIONS.",
    link: 'READ MORE >'
  },
  {
  ...
  {
    id: 10, type: 'color', span: 3, bgColor: '#08152d',
    title: 'DRIVING BUSINESS VALUE WITH AGENTIC AI',
    content: 'A Harvard Business Review Analytic Services Report sponsored by ALPHA GROUPS',
    link: 'READ MORE >'
  },
  {
  ...
  {
    id: 12, type: 'color', span: 3, bgColor: '#2E6BFF',
    title: 'THE NEXT BIG THING: ARTIFICIAL INTELLIGENCE',
    content: 'A Technology Leadership report in collaboration with ALPHA GROUPS',
    link: 'READ MORE >'
  },
  ...
  // row 4 (span 6)
  {
    ...
    title: 'State of Digital Transformation Report 2026'
  },
  {
  ...
  // row 5 (span 4)
  {
    id: 15, type: 'earnings', span: 4, bgColor: '#08152d',
    title: 'ACHIEVEMENTS',
    stats: [
      { label: 'Digital Projects Delivered', value: '500+', change: '▲ 45% YoY' },
      { label: 'Client Satisfaction', value: '98%', change: '▲ 5% YoY' }
    ]
  },
  {
    ...
    title: 'ALPHA GROUPS is proudly committed to sustainable digital transformation'
  },
  {
...
export function InfoGrid() {
      ...
      case 'color':
        return (
          <div className="inner-padding flex-col-between color-hover">
            ...
            {item.link && <a href="#" className="alpha-link">{item.link}</a>}
          </div>
        )
      case 'image':
  ...
  return (
    <section className="alpha-grid-section">
      <div className="alpha-grid-container">
        {gridData.map((item, index) => (
          <motion.div
            ...
            className={`alpha-cell col-span-${item.span}`}
