  ...
  return (
    <div className="bg-[#fafafa] text-slate-900 selection:bg-sky-100 selection:text-sky-900">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-end">
            <div className="lg:col-span-8">
              ...
              >
                ...
                <h1 className="text-6xl md:text-[5.5rem] font-bold leading-[0.95] tracking-tight mb-10 italic">
      ...
      <section className="py-24 border-y border-slate-100 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-px bg-slate-100">
            <div className="bg-white py-16 pr-12">
              <div className="flex items-start gap-6">
                <div className="p-4 bg-slate-50 rounded-2xl text-sky-600"><Target size={32} strokeWidth={1.5} /></div>
                <div>
                  <h2 className="text-3xl font-bold mb-4 italic">The Mission</h2>
            ...
            <div className="bg-white py-16 md:pl-12">
              <div className="flex items-start gap-6">
                <div className="p-4 bg-slate-50 rounded-2xl text-sky-600"><Eye size={32} strokeWidth={1.5} /></div>
                <div>
                  <h2 className="text-3xl font-bold mb-4 italic">The Vision</h2>
                  <p className="text-slate-500 text-lg leading-relaxed">
      ...
      <section className="py-32 bg-slate-900 text-white">
        <div className="container mx-auto px-6">
          <div className="mb-24 max-w-2xl">
            <h2 className="text-5xl font-bold mb-6 italic">A Decade of Defiance.</h2>
          ...
          <div className="relative">
            {timeline.map((item, index) => (
              ...
              >
                <div className="text-5xl font-black text-white/10 group-hover:text-sky-500 transition-colors duration-500 md:w-32">
                  {item.year}
                </div>
                <div className="md:flex-1">
                  ...
                  <p className="text-slate-400 max-w-xl text-lg leading-relaxed">{item.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-32 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4">
              <h2 className="text-4xl font-bold sticky top-32 italic">What <br />Drives Us.</h2>
            </div>
            <div className="lg:col-span-8 grid sm:grid-cols-2 gap-x-12 gap-y-20">
              {values.map((value) => (
                <div key={value.title} className="group">
                  <div className="text-sky-600 mb-6 group-hover:scale-110 transition-transform origin-left duration-300">
                    {value.icon}
                  </div>
                  <h3 className="text-xl font-bold mb-4 uppercase tracking-widest">{value.title}</h3>
                  <p className="text-slate-500 leading-relaxed font-light border-l-2 border-slate-100 pl-6 group-hover:border-sky-500 transition-colors">
                    {value.description}
                  </p>
                </div>
              ))}
      ...
      <section className="py-32 bg-slate-50">
        <div className="container mx-auto px-6">
          <div className="rounded-[3rem] bg-sky-600 p-12 md:p-24 text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-5xl font-bold mb-6 italic leading-tight">Driven by <br />Pure Expertise.</h2>
                <p className="text-xl text-sky-500/10 text-sky-100/80 font-light">
                  Our collective of developers, designers, and strategists don’t just work for us—they build for you.
                </p>
              </div>
              <div className="flex justify-start lg:justify-end">
                <button className="bg-white text-sky-600 px-10 py-5 rounded-full font-bold text-lg hover:bg-slate-100 transition-all flex items-center gap-3 group">
